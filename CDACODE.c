...
/* This is a CS1 concept (hashing) in a class that is based on the intro to C class. The pre-requisite to CDA 3103 is only the intro class COP 3223. 
I am not in CS1 and have completed this to the best of my abilities based on the intro class material.
*/
